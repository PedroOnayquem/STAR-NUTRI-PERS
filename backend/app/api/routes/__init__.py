...
from .file_monitoring import router as file_monitoring_router
...
api_router.include_router(legacy_chat_router)
api_router.include_router(health_router, tags=["health"])
api_router.include_router(file_monitoring_router)
